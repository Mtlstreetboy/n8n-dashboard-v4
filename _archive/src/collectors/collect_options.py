...
OUTPUT_DIR = '/data/options_data'
ALPHA_VANTAGE_KEY = 'YOUR_KEY_HERE'  # Optionnel, backup si Yahoo ??choue
...
class OptionsCollector:
    ...
    def get_options_data(self, ticker, days_forward=90):
        ...
        try:
            ...
            if not all_calls and not all_puts:
                print(f"??? Aucune donn??e collect??e pour {ticker}")
                return None
    ...
    def _calculate_sentiment_metrics(self, ticker, calls_df, puts_df):
        ...
        try:
            ...
            print(f"??????  Erreur calcul m??triques: {str(e)}")
            metrics['error'] = str(e)
    ...
    def _save_options_data(self, ticker, calls_df, puts_df, sentiment_metrics):
        """
        Sauvegarde les donn??es d'options
        """
        ...
        # Sauvegarder les m??triques de sentiment
    ...
    def collect_all_companies(self, companies, days_forward=90):
        ...
        print("\n" + "="*80)
        print("??? COLLECTE D'OPTIONS TERMIN??E")
        print("="*80)
