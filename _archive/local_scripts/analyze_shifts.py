#!/usr/bin/env python3
"""
Analyse avec param??tres optimis??s pour d??tecter les shifts
"""
import sys
...
def analyze_with_adjusted_params(ticker, data_path='/data/files/companies'):
    """
    Analyse avec param??tres adapt??s:
    - Seuil: 1.2?? (plus sensible)
    - Fen??tre shift: 14 jours
    - Min articles: 2
    - Lookback: 60 jours
    """
    ...
    detector = TrendDetector(
        ...
        shift_window_days=14,    # Fen??tre plus large
