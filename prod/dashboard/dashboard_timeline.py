...
if os.path.exists('/data/files/companies'):
    COMPANIES_DIR = "/data/files/companies"
else:
    # Local Windows: prod/dashboard -> prod -> root -> local_files -> companies
    COMPANIES_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'local_files', 'companies')
...
for i, ticker in enumerate(selected_tickers):
    ...
    if show_events:
        ...
        if events:
            ...
            # Spikes et Drops désactivés pour ne pas afficher de triangles
