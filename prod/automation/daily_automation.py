...
def run_command(command, description, timeout=300):
    ...
    # Determine cwd based on environment
...
def main():
    ...
    # Using relative paths from automation/ directory
    if run_command(
        [sys.executable, '../collection/collect_options.py'],
    ...
    if run_command(
        [sys.executable, '../collection/batch_loader_v2.py', '2'],
    ...
    if run_command(
        [sys.executable, '../analysis/analyze_all_sentiment.py'],
