...
notebook = {
    "cells": [
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 2. SEC API Connectivity Test"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 5. Test Production Module"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
...
with open('notebooks/sec_edgar_exploration_v2.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=1, ensure_ascii=False)

print('✅ Notebook created: notebooks/sec_edgar_exploration_v2.ipynb')
